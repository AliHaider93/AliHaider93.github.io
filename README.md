...
+ The implementation of elements and sections is halfway through and more work has to be done on the BRL-CAD side, like the implementation of the element pulley and element bearing 
